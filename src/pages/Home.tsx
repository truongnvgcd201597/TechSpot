        ...
        >
          <div className="flex flex-col sm:flex-row landing-page-wrapper md:w-4/5 sm:w-full md:my-8">
            <div className="flex md:w-2/7 sm:w-full">
              <img src="/img/iphonethumbnail.png" className="my-5" />
            </div>
            <div className="flex flex-col md:w-5/7 sm:w-full justify-center items-center px-10 sm:">
              <div className="md:w-50vw md:w-100vw">
                ...
                <h1 className="md:text-md text-gray-600 text-justify">
                  <span className="text-logogreen">Techspot</span> is a one-stop
                  destination for all your shopping needs. We offer over 1000+
                  products from popular brands at the never-seen before price
                  range with 20-days money back guarantee and cash on delivery!
                  <br />
                </h1>
                  ...
                  <ul className="mt-4 text-gray-300 text-gray-600">
                    <li>
                      <p className="mt-4 text-gray-700 text-gray-600">
                        TechSpot is a one-stop destination for all your shopping
                        needs.
                      </p>
                      <p className="mt-4 text-gray-700 text-gray-600">
                        We offer over 1000+ products from popular brands at the
                        never-seen before price range with 20-days money back
                        guarantee and cash on delivery!
                      </p>
                      <p className="mt-4 text-gray-700 text-gray-600">
                        We are a team of 5 members who are passionate about
                        technology and we want to make the best use of it to
